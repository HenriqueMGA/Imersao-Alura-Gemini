## One Piece Mugiwaras - Imersão Dev com Google Gemini

**O que essa aplicação faz?**

Imagine que você é um super fã de One Piece e quer saber tudo sobre seu Chapéu de Palha favorito. Aqui você encontrará todas as informações que você precisa de forma rápida e fácil. 

**Como ela funciona?**

1. **Digite e pesquise:** Você digita o nome do integrante do bando que você quer encontrar na caixinha de pesquisa.
...
3. **Resultados na tela:** Se a aplicação encontrar algo, ela mostra pra você um card com o nome do personagem, uma breve descrição e um link para saber mais. Se não encontrar nada, ela te avisa que não teve sorte dessa vez.
...
4. **Ou acesse o site:** [One Piece Mugiwaras](https://imersao-alura-gemini-beta.vercel.app/)
